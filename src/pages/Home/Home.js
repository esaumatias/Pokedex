            ...
            {detailsPokemon ? (
              detailsPokemon.map((value, index) => (
                <Link to={"/DetailsPokemon"} key={index}>
                  ...
                  >
                    <h5 className="text-center" value={value}>
                      {value.name}
                    </h5>
                    <img
                    ...
                    <div className="containerType">
                      <div className={value.types[0].type.name}>
                        {value.types[0].type.name}
                      </div>
                      {value.types[1] ? (
                        <div className={value.types[1].type.name}>
                          {value.types[1].type.name}
                        </div>
                      ) : null}
                      {value.types[2] ? (
                        <div className={value.types[2].type.name}>
                          {value.types[2].type.name}
                        </div>
                      ) : null}
                    </div>
                  </Button>
